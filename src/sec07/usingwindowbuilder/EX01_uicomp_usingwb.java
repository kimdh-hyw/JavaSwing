...
public class EX01_uicomp_usingwb extends JFrame {
	...
	public EX01_uicomp_usingwb() {
		...
		panel_1_1.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "TextField & TextArea", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		panel_1.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Button & Label", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		panel_2.setBorder(new TitledBorder(null, "CheckBox", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		panel_2_1.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "RadioButton", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		panel_2_1_1.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Slider and ProgressBar", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
